...
public class TidalModuleSurfaceTests
{
    ...
    /// This static method was deleted in WS3.1 (PR #134) as it had 0 call sites.
    ...
    public void TidalModule_PublicStaticMethodCount_IsExpected()
    {
        ...
        // Note: ValidateConfiguration has one overload for TidalIndexerSettings, one for TidalDownloadClientSettings
