...
- `src/Tidalarr` houses Application services, Domain models, Infrastructure adapters, and Integration clients; add new code in the matching layer.
...
**Why Not Now**: The conservative WS3.1 cleanup (PR #134) deleted dead code and added characterization tests. The full refactor requires coordinating CLI changes and has regression risk without the interface abstraction layer.
